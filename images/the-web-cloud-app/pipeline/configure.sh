...
override 'httpServer.environmentVariables.encoded.GITHUB_PACKAGES_TOKEN' "$GITHUB_PACKAGES_TOKEN"
...
override 'tester.environmentVariables.encoded.GITHUB_PACKAGES_TOKEN' "$GITHUB_PACKAGES_TOKEN"
